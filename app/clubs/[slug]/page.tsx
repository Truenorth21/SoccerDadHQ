          ...
          <div className="relative -mt-16 flex flex-col gap-4 sm:-mt-20 sm:flex-row sm:items-end">
            ...
            <div className="flex-1 pb-2">
              <div className="flex flex-wrap items-center gap-2">
                ...
                {club.verified && <span className="chip-sky">✓ Verified</span>}
              ...
              <div className="mt-5 grid gap-4 sm:grid-cols-2">
                ...
                {club.tryouts_open && (
                  <div className="card border-l-4 border-brand-amber p-4">
                    ...
                    <p className="text-sm text-slate-700">{club.tryout_note}</p>
                  </div>
                )}
              </div>
            </section>
          ...
          <div className="space-y-6 lg:sticky lg:top-20 lg:self-start">
            ...
            <div className="card border-2 border-dashed border-slate-200 p-5 text-center">
              <h3 className="font-heading text-lg font-bold text-navy">
                {club.claimed ? "This club is claimed" : "Is this your club?"}
              </h3>
              <p className="mt-1 text-sm text-slate-500">
                {club.claimed
                  ? "A club representative manages this profile."
                  : "Claim this profile to update info, respond to reviews and post tryouts."}
              </p>
              {!club.claimed && (
                <div className="mt-3">
                  <ClaimForm subjectType="club" subjectSlug={club.slug} subjectName={club.name} />
                  <Link href="/advertise#tiers" className="mt-2 inline-block text-xs font-semibold text-brand-blue hover:underline">
            ...
            {!club.featured && <AdSlot placement="profile-sidebar" seed={club.name.length} />}
          </div>
        </div>
